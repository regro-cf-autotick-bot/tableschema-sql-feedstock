...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tableschema-sql-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7511&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tableschema-sql-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tableschema-sql` can be installed with:

```
conda install tableschema-sql
```

It is possible to list all of the versions of `tableschema-sql` available on your platform with:
